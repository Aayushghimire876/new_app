...
import 'package:new_app/model/vegatable_model.dart' hide Fruitmodel;
...
class GroceryListProvider with ChangeNotifier {
  ...
  bool isVegetableState() {
    return _groceryListState == GroceryListState.vegatable;
  }
}

enum GroceryListState { fruit, vegatable }
